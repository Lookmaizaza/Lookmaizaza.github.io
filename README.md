# 👋 I'm Kanokphorn Rungrattanapong (Lookmai)
...
ในโปรเจกต์นี้ ดิฉันได้นำข้อมูลจาก [**data.go.th**](https://data.go.th/dataset/0505_17_3017) มาถอดรหัสพฤติกรรมการเดินทางของประชากรไทย โดยใช้ Framework **DIKW Pyramid** เพื่อเปลี่ยนข้อมูลดิบให้กลายเป็น Insight ที่ใช้ตัดสินใจได้จริง
...
### 🔗 [**Full Project Details**](Travel-Mode-Analysis.md)
